                ...
                <div class="s-header__navbar-row-col">
                    ...
                    <div class="s-header__logo">
                        <a href="index.html" class="s-header__logo-link">
                            <img style="height: 70px" class="s-header__logo-img s-header__logo-img-default" src="images/Sopconsulting Logo2.png" alt="Megakit Logo">
                            <img style="height: 55px" class="s-header__logo-img s-header__logo-img-shrink" src="images/Sopconsulting Logo2.png" alt="Megakit Logo">
                        </a>
                    </div>
                    <!-- End Logo -->
                </div>
        ...
        <nav class="s-header__nav js__scrollbar">
            <div class="container-fluid">
                ...
                <ul class="list-unstyled s-header__nav-menu">
                    <li class="s-header__nav-menu-item"><a class="s-header__nav-menu-link s-header__nav-menu-link-divider" href="index.html">Strategy </a></li>
                    <li class="s-header__nav-menu-item"><a class="s-header__nav-menu-link s-header__nav-menu-link-divider" href="index_app_landing.html">Organization </a></li>
                    <li class="s-header__nav-menu-item"><a class="s-header__nav-menu-link s-header__nav-menu-link-divider" href="index_portfolio.html">People </a></li>
                </ul>
                <ul class="list-unstyled s-header__nav-menu">
                    ...
                    <li class="s-header__nav-menu-item"><a class="s-header__nav-menu-link s-header__nav-menu-link-divider" href="team.html">Contact</a></li>
        ...
        <div class="g-fullheight--xs g-bg-position--center swiper-slide" style="background: url('img/1920x1080/02.jpg');">
            <div class="container g-text-center--xs g-ver-center--xs">
                <div class="g-margin-b-30--xs">
                    <h1 class="g-font-weight--700 g-font-size-45--xs g-font-size-55--sm g-font-size-65--md g-color--white">
...
<!--========== PAGE CONTENT ==========-->
<!-- Features -->
<div id="js__scroll-to-section" class="container g-padding-y-50--xs g-padding-y-100--sm">
    <div class="g-text-center--xs">
        <p class="text-uppercase g-font-size-14--xs g-font-weight--700 g-color--primary g-letter-spacing--2 g-margin-b-25--xs">Welcome to SOP Consulting </p>
        <h2 class="g-font-size-25--xs g-font-size-30--md">
            Offering quality innovative and client <br> focused Organisational Development and
            Human Resources Solutions in Zimbabwe and beyond</h2>
    </div>
</div>

<!-- Mockup -->
<section class="g-bg-color--sky-light">
    <div id="js__scroll-to-section" class="container g-padding-y-80--xs g-padding-y-125--xsm ">
        <div class="row g-hor-centered-row--md g-row-col--5 g-margin-b-80--xs g-margin-b-100--md">
            <div class="col-sm-5 g-hor-centered-row__col">
                ...
                <h2 class="g-font-size-32--xs g-font-size-36--sm g-margin-b-25--xs">Strategy Setting</h2>
                <p class="g-font-size-18--sm">Are you seeking to pursue new business priorities or grow your business or determine a new product/service or just refocusing on key strategic imperatives or seeking a new strategic direction for your organization?</p>
                <p class="g-font-size-18--sm"><a href="" class="text-uppercase s-btn s-btn--sm s-btn--primary-brd g-radius--50 g-padding-x-40--xs g-margin-t-10--lg">Read More</a></p>
            </div>
            <div class="col-sm-1"></div>
            <div class="col-sm-5 g-hor-centered-row__col">
                <img class="img-responsive" src="page-img/strategy.png" alt="Mockup Image">
            </div>
        </div>
        <div class="row g-hor-centered-row--md g-row-col--5 g-margin-b-80--xs g-margin-b-100--md">
            <div class="col-sm-5 col-sm-push-7 g-hor-centered-row__col">
                <p class="text-uppercase g-font-size-14--xs g-font-weight--700 g-color--primary g-letter-spacing--2 g-margin-b-25--xs">STRATEGY</p>
                <h2 class="g-font-size-32--xs g-font-size-36--sm g-margin-b-25--xs">Performance Management</h2>
                <p class="g-font-size-18--sm">Employee performance is critical to the attainment of an organization’s strategic objectives. It therefore goes without say that for maximum impact, the efforts and contribution of each and every employee has to be managed in a focused and structured manner. Our approach and tools for managing performance create a direct line of sight between people’s day-to-day activities and the strategy</p>
                <p class="g-font-size-18--sm"><a href="" class="text-uppercase s-btn s-btn--sm s-btn--primary-brd g-radius--50 g-padding-x-40--xs g-margin-t-10--lg">Read More</a></p>
            </div>
            <div class="col-sm-1"></div>
            <div class="col-sm-5 col-sm-pull-7 g-hor-centered-row__col g-text-left--xs g-text-right--md">
                <img class="img-responsive" src="page-img/st-3.png" alt="Mockup Image">
            </div>
        </div>
        <div class="row g-hor-centered-row--md g-row-col--5 g-margin-b-80--xs g-margin-b-100--md">
            <div class="col-sm-5 g-hor-centered-row__col">
...
<div class="js__parallax-window" style="background: url(img/1920x1080/03.jpg) 50% 0 no-repeat fixed;">
    <div class="container g-text-center--xs g-padding-y-80--xs g-padding-y-125--sm">
        <div class="g-margin-b-80--xs">
            <h2 class="g-font-size-40--xs g-font-size-50--sm g-font-size-60--md g-color--white">We offer more services</h2>
        </div>
        ...
        <div class="row">
            <div class="col-md-4 g-margin-t-15--xs g-margin-b-60--xs g-margin-b-0--lg">
                ...
                <div class="wow fadeInLeft" data-wow-duration=".3" data-wow-delay=".1s">
                    <h2 class="g-font-size-40--xs g-font-size-50--sm g-font-size-60--md">SOP</h2>
                </div>
                <div class="wow fadeInLeft" data-wow-duration=".3" data-wow-delay=".3s">
                    <h2 class="g-font-size-40--xs g-font-size-50--sm g-font-size-60--md">Consulting</h2>
                </div>
            </div>
            <div class="col-md-4 col-md-offset-1">
                <p class="g-font-size-18--xs text-justify"> We are a highly specialized Team of Consulting Experts providing Management solutions in the
                    areas of Organizational Development and People Management. Founded in 2008, SOP Consulting has
                    successfully delivered Management solutions to a wide range of client organizations in Zimbabwe
                    and beyond.</p>
                <p class="g-font-size-18--xs text-justify">
                    Having undertaken various consulting assignments across different industries, we have amassed
                    invaluable experience in our areas of specialization. We employ various dynamic strategies to
                    create healthy and sustainable organizations. Our strategies unlock the human capital in client
                    organizations
                </p>
            </div>
        </div>
...
<footer class="g-bg-color--dark">
    ...
    <div class="container g-padding-y-50--xs">
        <div class="row">
            <div class="col-xs-6">
                <a href="index.html">
                    <img style="height: 40px" src="images/Sopconsulting Logo2.png" alt="Megakit Logo">
                </a>
            </div>
            <div class="col-xs-6 g-text-right--xs">
                <p class="g-font-size-14--xs g-margin-b-0--xs g-color--white-opacity-light"> Site Done by  <a href="">Starlight</a></p>
            </div>
        </div>
    </div>
    <!-- End Copyright -->
...
<?php /**PATH /home/gujie/Desktop/Code/Projects/consultancy/resources/views/layouts/app.blade.php ENDPATH**/ ?>